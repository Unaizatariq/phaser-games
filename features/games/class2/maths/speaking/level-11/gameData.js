window.GAME_DATA = {
  ...
  "level": 11,
  "topic": "Time Clock",
  "teach": "Time Clock builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Time Clock",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Time Clock?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Time Clock?"
    },
    {
      "type": "speech",
