window.GAME_DATA = {
  ...
  "level": 4,
  "topic": "Pronouns",
  "teach": "Pronouns helps children read, speak and write clear English sentences.",
  "examples": [
    "read",
    "understand",
    "use in sentence"
  ...
  "questions": [
    {
      "type": "input",
      "prompt": "Write the answer: Pronouns is part of",
      "answer": "English grammar",
      "options": [],
      "audioText": "Write the answer: Pronouns is part of"
    },
    {
      "type": "input",
