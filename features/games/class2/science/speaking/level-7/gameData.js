window.GAME_DATA = {
  ...
  "level": 7,
  "topic": "Saving Water",
  "teach": "Saving Water helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Saving Water belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Saving Water belongs to which subject?"
    },
    {
      "type": "speech",
