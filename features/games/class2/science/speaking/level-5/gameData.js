window.GAME_DATA = {
  ...
  "teach": "Plants Grow from Seeds helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Plants Grow from Seeds belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Plants Grow from Seeds belongs to which subject?"
    },
    {
      "type": "speech",
