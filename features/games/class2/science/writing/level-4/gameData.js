window.GAME_DATA = {
  ...
  "teach": "Familiar Animals helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "input",
      "prompt": "Familiar Animals belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Familiar Animals belongs to which subject?"
    },
    {
      "type": "input",
