window.GAME_DATA = {
  ...
  "level": 13,
  "topic": "Patterns",
  "teach": "Patterns builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Patterns",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Patterns?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Patterns?"
    },
    {
      "type": "speech",
