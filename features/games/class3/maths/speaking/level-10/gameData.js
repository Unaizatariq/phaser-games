window.GAME_DATA = {
  ...
  "teach": "Time and Calendar builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Time and Calendar",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Time and Calendar?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Time and Calendar?"
    },
    {
      "type": "speech",
