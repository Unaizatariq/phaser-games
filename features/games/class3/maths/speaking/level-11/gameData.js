window.GAME_DATA = {
  ...
  "teach": "Money Problems builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Money Problems",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Money Problems?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Money Problems?"
    },
    {
      "type": "speech",
