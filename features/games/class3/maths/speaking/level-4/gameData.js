window.GAME_DATA = {
  ...
  "teach": "Multiplication builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Multiplication",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Multiplication?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Multiplication?"
    },
    {
      "type": "speech",
