window.GAME_DATA = {
  ...
  "teach": "Basic Fractions builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Basic Fractions",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Basic Fractions?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Basic Fractions?"
    },
    {
      "type": "speech",
