window.GAME_DATA = {
  ...
  "teach": "Sources of Heat and Light helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Sources of Heat and Light belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Sources of Heat and Light belongs to which subject?"
    },
    {
      "type": "speech",
