window.GAME_DATA = {
  ...
  "teach": "Sun Moon Stars helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Sun Moon Stars belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Sun Moon Stars belongs to which subject?"
    },
    {
      "type": "speech",
