window.GAME_DATA = {
  ...
  "level": 6,
  "topic": "Adverbs",
  "teach": "Adverbs helps children read, speak and write clear English sentences.",
  "examples": [
    "read",
    "understand",
    "use in sentence"
  ...
  "questions": [
    {
      "type": "input",
      "prompt": "Write the answer: Adverbs is part of",
      "answer": "English grammar",
      "options": [],
      "audioText": "Write the answer: Adverbs is part of"
    },
    {
      "type": "input",
