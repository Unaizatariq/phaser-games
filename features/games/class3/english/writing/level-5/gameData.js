window.GAME_DATA = {
  ...
  "level": 5,
  "topic": "Adjectives",
  "teach": "Adjectives helps children read, speak and write clear English sentences.",
  "examples": [
    "read",
    "understand",
    "use in sentence"
  ...
  "questions": [
    {
      "type": "input",
      "prompt": "Write the answer: Adjectives is part of",
      "answer": "English grammar",
      "options": [],
      "audioText": "Write the answer: Adjectives is part of"
    },
    {
      "type": "input",
