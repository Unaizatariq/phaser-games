window.GAME_DATA = {
  ...
  "level": 11,
  "topic": "Basic Tenses",
  "teach": "Basic Tenses helps children read, speak and write clear English sentences.",
  "examples": [
    "read",
    "understand",
    "use in sentence"
  ...
  "questions": [
    {
      "type": "input",
      "prompt": "Write the answer: Basic Tenses is part of",
      "answer": "English grammar",
      "options": [],
      "audioText": "Write the answer: Basic Tenses is part of"
    },
    {
      "type": "input",
