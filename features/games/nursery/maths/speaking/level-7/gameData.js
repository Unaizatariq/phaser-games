window.GAME_DATA = {
  ...
  "teach": "Missing Numbers builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Missing Numbers",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Missing Numbers?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Missing Numbers?"
    },
    {
      "type": "speech",
