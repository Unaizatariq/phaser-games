window.GAME_DATA = {
  ...
  "level": 1,
  "topic": "My Body Parts",
  "teach": "My Body Parts helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "input",
      "prompt": "My Body Parts belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "My Body Parts belongs to which subject?"
    },
    {
      "type": "input",
