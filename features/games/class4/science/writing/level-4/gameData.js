window.GAME_DATA = {
  ...
  "teach": "Human Teeth Functions helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "input",
      "prompt": "Human Teeth Functions belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Human Teeth Functions belongs to which subject?"
    },
    {
      "type": "input",
