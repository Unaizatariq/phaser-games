window.GAME_DATA = {
  ...
  "teach": "Properties of Matter helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Properties of Matter belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Properties of Matter belongs to which subject?"
    },
    {
      "type": "speech",
