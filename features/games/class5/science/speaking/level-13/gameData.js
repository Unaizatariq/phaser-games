window.GAME_DATA = {
  ...
  "teach": "Earth Moon Sun Movements helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Earth Moon Sun Movements belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Earth Moon Sun Movements belongs to which subject?"
    },
    {
      "type": "speech",
