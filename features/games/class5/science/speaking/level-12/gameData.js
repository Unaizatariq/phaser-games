window.GAME_DATA = {
  ...
  "teach": "Soil Types Importance helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Soil Types Importance belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Soil Types Importance belongs to which subject?"
    },
    {
      "type": "speech",
