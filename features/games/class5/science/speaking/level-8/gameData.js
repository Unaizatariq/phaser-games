window.GAME_DATA = {
  ...
  "teach": "Sound and Noise Pollution helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Sound and Noise Pollution belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Sound and Noise Pollution belongs to which subject?"
    },
    {
      "type": "speech",
