window.GAME_DATA = {
  ...
  "teach": "Light Properties Uses helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: Light Properties Uses belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Say the answer: Light Properties Uses belongs to which subject?"
    },
    {
      "type": "speech",
