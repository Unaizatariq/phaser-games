window.GAME_DATA = {
  ...
  "teach": "Electricity Static Simple Circuits helps children observe the world, ask questions and understand how living and non-living things work.",
  "examples": [
    "observe",
    "learn",
    "explain"
  ...
  "questions": [
    {
      "type": "input",
      "prompt": "Electricity Static Simple Circuits belongs to which subject?",
      "answer": "science",
      "options": [],
      "audioText": "Electricity Static Simple Circuits belongs to which subject?"
    },
    {
      "type": "input",
