window.GAME_DATA = {
  ...
  "level": 7,
  "topic": "Fractions",
  "teach": "Fractions builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Fractions",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Fractions?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Fractions?"
    },
    {
      "type": "speech",
