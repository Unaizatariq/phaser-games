window.GAME_DATA = {
  ...
  "teach": "Basic Decimals builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Basic Decimals",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Basic Decimals?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Basic Decimals?"
    },
    {
      "type": "speech",
