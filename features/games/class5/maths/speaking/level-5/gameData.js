window.GAME_DATA = {
  ...
  "level": 5,
  "topic": "Division",
  "teach": "Division builds number thinking through examples, counting, solving and real-life problems.",
  "examples": [
    "Division",
    "example",
    "solve"
  ...
  "questions": [
    {
      "type": "speech",
      "prompt": "Say the answer: What is the main skill in Division?",
      "answer": "solving carefully",
      "options": [],
      "audioText": "Say the answer: What is the main skill in Division?"
    },
    {
      "type": "speech",
